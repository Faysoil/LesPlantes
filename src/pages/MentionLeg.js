...
<div className="container" style={{ overflow: 'auto', maxHeight: '80vh' }}>
      ...
      <p>
        L'entreprise individuelle AROSAJE, soucieuse des droits des individus,
        ...
        puissent au mieux exercer leurs droits. Pour toute information complémentaire
        sur la protection des données personnelles, nous vous invitons à consulter
        le site :{" "}
      ...
      <p>
        ...
        dispositions et conditions d'utilisation qui suivent. La version actuellement
        en ligne de ces conditions d'utilisation est la seule opposable pendant toute
      ...
      <h3>1.2 Éditeur</h3>
      <p>
        L'entreprise individuelle AROSAJE
        <br />
        45 rue sergent michel berthet, 69009
        <br />
        Immatriculée au RCS de Lyon 234567890
        <br />
        N° de téléphone : 0678765664
        <br />
        Adresse mail : epsi@arosaje.fr
      </p>
      <h3>1.3 Hébergeur</h3>
      <p>
        Arosaje est hébergé par HOSTINGER, dont le siège social est situé PARIS 75011.
      </p>
      <h3>1.4 Délégué à la protection des données (DPO)</h3>
      <p>
        Un délégué à la protection des données : Farhati MOHAMED, farhati@epsi.fr,
        est à votre disposition pour toute question relative à la protection de vos
      ...
      <p>
        ...
        de sollicitation commerciale et notamment l'envoi de courriers électroniques non
        sollicités.
      </p>
      ...
      <p>
        ...
        images animées ou non, séquences vidéo, sons, ainsi que toutes les applications
        informatiques qui pourraient être utilisées pour faire fonctionner </p>
...
Si l'éditeur venait à faire l'objet d'une procédure amiable ou judiciaire en raison de votre utilisation du site, il pourra se retourner contre vous pour obtenir l'indemnisation de tous les préjudices, sommes, condamnations et frais qui pourraient découler de cette procédure.	
      ...
      <p>La mise en place par les utilisateurs de tous liens hypertextes vers tout ou partie du site est autorisée par l'éditeur. Tout lien devra être retiré sur simple demande de l'éditeur. 
Toute information accessible via un lien vers d'autres sites n'est pas publiée par l'éditeur. L'éditeur ne dispose d'aucun droit sur le contenu présent dans ledit lien. 
      ...
      <p>Vos données sont collectées par l'entreprise individuelle AROSAJE.
...
- adresse mail
- numéro de téléphone
- métier, plantes gardés
Un délégué à la protection des données : Farhati MOHAMED, farhati@epsi.fr, est à votre disposition pour toute question relative à la protection de vos données personnelles.
</p>
...
epsi@arosaje.fr 
Vous pouvez aussi vous adresser à notre délégué à la protection des données : Farhati MOHAMED, farhati@epsi.fr, qui est à votre disposition pour toute question relative à la protection de vos données personnelles.
...
<p>Vous êtes susceptible de recevoir des offres commerciales de l'éditeur. Si vous ne le souhaitez pas, veuillez cliquer sur le lien suivant : infos@arosaje.fr.
Vos données sont susceptibles d’être utilisées par les partenaires de l'éditeur à des fins de prospection commerciale, si vous ne le souhaitez pas, veuillez cliquer sur le lien suivant : infos@arosaje.fr.
...
<h2>Article 13 - Photographies et représentation des produits</h2>
...
<h2>Article 15 - Contactez-nous</h2>

<p>Pour toute question, information sur les produits présentés sur le site, ou concernant le site lui-même, vous pouvez laisser un message à l'adresse suivante : epsi@arosaje.fr.</p>
