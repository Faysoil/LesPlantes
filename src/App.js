...
<div class="text-center mt-24">
  ...
  <span class="text-sm">ou <a href="./Inscription" class="text-blue-500">
     S'inscire
  </a>
</span>
</div>
  ...
  <div class="flex flex-wrap -mx-3 mb-6">
     ...
     <div class="w-full flex items-center justify-between px-3 mb-3 ">
        <label for="remember" class="flex items-center w-1/2">
           ...
           <span class="text-sm text-gray-700 pt-1">Se souvenir</span>
        </label>
        <div class="w-1/2 text-right">
           <a href="#" class="text-blue-500 text-sm tracking-tight">J'ai oublier mon mdp</a>
        </div>
     </div>
     <div class="w-full md:w-full px-3 mb-6">
     <button class="appearance-none block w-full bg-blue-600 text-gray-100 font-bold border border-gray-200 rounded-lg py-3 px-3 leading-tight hover:bg-blue-500 focus:outline-none focus:bg-white focus:border-gray-500"><a href="./BlogPlantes">Se connecter</a></button>
     </div>
     <div class="mx-auto -mb-6 pb-1">
        <span class="text-center text-xs text-gray-700">ou se connecter avec <br></br> (c'est une blague ca marche pas)</span>
     </div>
